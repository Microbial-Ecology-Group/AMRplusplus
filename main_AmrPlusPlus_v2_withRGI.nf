...
/* This doesn't work with the singularity container, so I'll just leave the CARD downlaod as a manual option.
process DL_CARD_db {
 
     publishDir "${params.output}/CARD_db", mode: "symlink"

     output:
         file("card.json") into card_db
