...
workflow {
    ...
    else if(params.pipeline == "bam_coverage_evaluation"){
        logPipelineStart("BAM Coverage Threshold Evaluation",
            "Per-BAM coverage_threshold_evaluation.py + plot_evaluation_dropoff.R summary.\n    Input: ${params.bam_files}")
        Channel
            .fromPath(params.bam_files)
            .ifEmpty { exit 1, "BAM files could not be found: ${params.bam_files}" }
