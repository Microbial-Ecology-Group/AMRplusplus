...
def help() {
    println ""
    println "Program: AMR++"
    println "Documentation: https://github.com/Microbial-Ecology-Group/AMRplusplus/blob/master/README.md"
    println "Contact: Enrique Doster <enriquedoster@gmail.com>"
    println ""
    println "Usage:    nextflow run main_AMR++.nf [options]"
    println ""
    ...
    println "    --kraken_db      STR      path to kraken database"
    println ""
